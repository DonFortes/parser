    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('main_block_class_name', models.CharField(max_length=255, verbose_name='Класс главного блока')),
                ...
                ('url_first_part', models.CharField(max_length=255, verbose_name='Неизменяемая первая часть ссылки')),
            ],
            options={
